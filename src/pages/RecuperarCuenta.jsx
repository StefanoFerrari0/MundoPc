        ...
        <section className="grid grid-cols-2 xs:grid-cols-1 sm:grid-cols-1 xs:mx-auto sm:mx-auto mr-20">
          <div className="bg-cover bg-left-top w-full h-full" style={{ backgroundImage: "url("+Image+")" }}></div>
            <div className="grid grid-cols-4 pt-20 pl-16">
             ...
             <Subtitle class="col-span-3" text="Ingresa tu correo electrónico para que recuperes el acceso a tu cuenta."/>
                <form className="grid grid-cols-4 col-span-3 mb-10 pt-10 " onSubmit={this.handleSubmit}>
                    ...
                    <button type="submit" className="bg-rojo hover:bg-red-500 text-blanco font-bold mt-10 py-2 px-4 mb-5 border border-rojo rounded-lg col-span-4">Recuperar cuenta</button>
                </form>
            </div>
        </section>
    )
