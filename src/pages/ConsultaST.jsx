...
export default class ConsultaST extends Component {
    ...
    render() {
      return  <section className="grid grid-cols-2 xs:grid-cols-1 sm:grid-cols-1 xs:mx-auto xs:text-center mr-20">
      <div className="bg-cover bg-left-top w-full h-full" style={{ backgroundImage: "url("+Image+")" }}></div>
        <div className="bg-white shadow overflow-hidden pt-20 pl-10 sm:rounded-lg">
            <div>
                ...
                <TableRow text1="¿Listo para retirar?:" class1="text-rojo font-bold" text2="Si." class2="uppercase"/>
                </dl>
            </div>
        </div>
    </section>
