...
const Error = () => {
    return (
        <div className="pattern flex align-center justify-center text-center flex-col h-screen">
            ...
            <button className="bg-rojo text-blanco hover:bg-negro hover:text-blanco font-bold mt-10 mx-auto py-2 px-4 mb-5 border border-rojo rounded-lg w-1/2"><Link to="/" >Volver al Home</Link></button>
            </div>
        </div>
    )
}
