        ...
        return (
          <div className="container mx-auto">
            ...
            <form onSubmit={this.searchProduct}>
              <Input name="search" type="number" placeholder="Buscar producto" value={this.state.search} onChange={this.handleChange} class="pl-5 mx-5"/>
                    ...
                    
            {
              ...
              <ProductItemAdmin key={_p.id} id={_p.id} image={_p.image} code={_p.code} name={_p.description} price={_p.price} stock={_p.stock} delete={this.deleteProduct(_p.id)}/>)
            }
          </div>
        )
    }
